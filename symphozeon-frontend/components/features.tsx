...
import { Music, Users, MessageSquare, Compass, Users2, Rss, Share2, X } from "lucide-react"
  ...
  const [features, setFeatures] = useState([
    {
      ...
      description:
        "Create or join virtual rooms where music lovers gather to share and discover tracks together. Experience synchronized playback with friends and new connections from around the world.",
      details: [
        "Host up to 50 listeners in a single room",
        "Synchronized playback across all devices",
        "Custom room themes and privacy settings",
        "Room chat with emoji reactions",
      ],
      color: theme === "dark" ? "from-purple-600 to-amber-500" : "from-amber-400 to-amber-600",
    },
    {
      icon: <Music size={40} className="feature-icon" />,
      title: "DJ playback controls",
      description:
        "Take turns as DJ with full playback controls and role assignments. Queue tracks, adjust volume, and create the perfect musical journey for your audience.",
      details: [
        "Seamless DJ handoffs with waiting queue",
        "Advanced mixing and crossfade controls",
        "Save and share your DJ sets",
        "Audience feedback in real-time",
      ],
      color: theme === "dark" ? "from-amber-500 to-purple-600" : "from-amber-500 to-amber-700",
    },
    {
      icon: <MessageSquare size={40} className="feature-icon" />,
      title: "Vibe voting and live chat",
      description:
        "React to tracks in real-time with emoji reactions and connect with others through integrated live chat. Share thoughts on tracks and discover common musical interests.",
      details: [
        "Emoji reactions that appear on the waveform",
        "Thread discussions about specific tracks",
        "Share track timestamps with one click",
        "Connect with users who share your taste",
      ],
      color: theme === "dark" ? "from-purple-500 to-amber-600" : "from-amber-300 to-amber-500",
    },
    {
      icon: <Compass size={40} className="feature-icon" />,
      title: "Genre-based discovery",
      description:
        "Explore new music through curated genre-based rooms and personalized recommendations. Our algorithm learns your taste and suggests rooms and tracks you'll love.",
      details: [
        "AI-powered recommendations based on listening history",
        "Weekly discovery playlists tailored to you",
        "Genre exploration tools with mood filtering",
        "Follow curators with similar taste",
      ],
      color: theme === "dark" ? "from-purple-600 to-amber-500" : "from-amber-400 to-amber-600",
    },
    {
      icon: <Users2 size={40} className="feature-icon" />,
      title: "Artist fan forums",
      description:
    ...
    {
      icon: <Rss size={40} className="feature-icon" />,
      title: "Personalized music feed",
      description:
    ...
    {
      icon: <Share2 size={40} className="feature-icon" />,
      title: "Playlist sharing & collaboration",
      description:
